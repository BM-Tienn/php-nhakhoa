                    ...
                    <div class="footer-logo">
                      <figure>
                        <a href="index.html">
                         ...
                         <h1> PHÒNG KHÁM <br> NHI NANNCY</h1> 
                        </a>
                      </figure>
                    </div>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, temporibus?</p> -->
                     <ul class="location-link"> <!--làm cho icon fa fa ngang với chữ -->
                      <!-- <li class="item">
                        <i class="fa fa-map-marker"></i>
                        <p>615A Trần Hưng Đạo, Q. 5, TP. Hồ Chí Minh</p>
                      </li> -->
                      <!-- <li class="item">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        <a href="#">
                          <p>nhikhoanancy@yahoo.com</p> 
                        </a>
                      </li>-->
                      <!-- <li class="item">
